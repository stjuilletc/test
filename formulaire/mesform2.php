...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <h1>Veuillez sélectionner le formulaire que vous souhaitez remplir . </h1>
    </head>
    <body>
    <br/ >
    <ul>
    	<ul>
    		<li><strong> Les formulaires  :</strong></li>
    	</ul>
    ...
    $fichier = $bdd->query('SELECT DISTINCT Nom FROM questions ');
			 while($donnees = $fichier->fetch()){ ?>
			 	<li> <a href=<?php echo '"formrep.php?name='.$donnees['Nom'].'"'; ?> ><?php echo $donnees['Nom']; ?></a><?php 
